    ...
    <MDXProvider components={mdxComponents}>
      ...
      {showDateWarning && (
        <div className="mt-8 py-3 px-4 bg-red-900 rounded-xl">
          ...
          <strong className="font-medium">over two years old</strong>. Tech can
          change really fast, so make sure the advice here is still valid before
          using it, especially if the post contains code samples.
        </div>
      )}
